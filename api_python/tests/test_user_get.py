...
class TestUserGet(BaseCase):
    ...
    def test_get_user_details_auth_as_same_user(self):
        ...
        # Assertions.assert_json_have_key(response2, 'username')
        # Assertions.assert_json_have_key(response2, 'email')
        # Assertions.assert_json_have_key(response2, 'firstName')
        # Assertions.assert_json_have_key(response2, 'lastName')
